...
Меня зовут Ардеев Данил, я студент 3 курса Ногинского колледжа. Увлекаюсь веб-разработкой, созданием пользовательских интерфейсов и изучением современных технологий. Стремлюсь к постоянному профессиональному росту и развитию в IT-сфере.
...
|--------|----------|------------|
| [Интернет-магазин](C:\Users\zona4_6\Documents\portfolio-SHPALA198\projects\task1-cssgrid) | Полнофункциональный макет интернет-магазина | HTML, CSS, JS, Bootstrap |
